 ...
 * @author anandpatel
 * 
 * This solution is find the  number pair from both array whoes sum is nearest to given number.
 *  a1 = { -1, 3, 8, 2, 9, 5 };
 *  a2 = { 4, 1, 2, 10, 5, 20 };
 *  aTarget = 24;
 *  
 *  result will be {3,20} , here 3 is from a1 and 20 is from a2
 *
 */
public class FindClosetSumFromTwoArray {
  public static void main(String[] args) {
    // NOTE: You can use the following input values to test this function.
    int[] a1 = { -1, 3, 8, 2, 9, 5 };
    int[] a2 = { 4, 1, 2, 10, 5, 20 };
    int aTarget = 24;
    int[] target = closestSumPair(a1, a2, aTarget); // should return {5, 20} or {3, 20}
    System.out.println("Result :");
    for (int data : target) {
      System.out.println("number are :" + data);
    }
    int[] b1 = { 7, 4, 1, 10 };
    int[] b2 = { 4, 5, 8, 7 };
    int bTarget = 13;
