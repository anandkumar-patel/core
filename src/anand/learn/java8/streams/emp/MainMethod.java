...
public class MainMethod {
	...
	public static void main(String[] args) {
		...
		Map<Integer, String> activeEmpMap1 = empList.stream()
				.collect(Collectors.toMap(Employee::getEmpId, Employee::getEmpName));
		Map<Integer, String> activeEmpMap2 = empList.stream()
				.collect(Collectors.toMap(emp -> emp.getEmpId(), emp -> emp.getEmpName()));
		Map<Integer, Employee> activeEmpMap = empList.stream()
		...
		System.out.println(empList.stream().collect(Collectors.groupingBy(emp -> emp.getEmpName(),
				Collectors.mapping(emp -> emp.getEmpId(), Collectors.toList()))));
