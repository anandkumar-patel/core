...
public class PrivateMethodOuterOverridding {
	...
	class Inner extends PrivateMethodOuterOverridding {
		private void fun() {
	...
	public static void main(String args[]) {
		...
		PrivateMethodOuterOverridding o = new PrivateMethodOuterOverridding();
		Inner i = o.new Inner();
